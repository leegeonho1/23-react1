...
합성이란?
   ...
   - 여러 개의 컴포넌트를 합셔처 새로운 컴포넌트를 만드는 것
...
- Containment
    ...
    - 리액트 컴포넌트의 props에 기본적으로 들어있는 children 속성을 이용

    - 여러 개의 children 집합이 필요한 경우 별도로 props를 각각 정의해서 이용

- Specialization

    - 범용적인 개념을 구별되게 구체화 하는 것
...
![image](https://github.com/leegeonho1/23-react1/assets/118963538/06835650-1669-44cb-87b5-d368e0d90a46)
...
![image](https://github.com/leegeonho1/23-react1/assets/118963538/af797040-b77d-4442-829c-44a08ce2eee2)
 ...
 ![image](https://github.com/leegeonho1/23-react1/assets/118963538/2db40c51-2656-4e83-90f4-812ae92b6db4)

     중간에 위치한 컴포넌트 테마 데이터를 하위 컴포넌트로 전달할 필요가 없다.

     리액트는 가장 가까운 상위 테마 Provider를 찾아서 해당 되는 값을 사용한다.
    
     만약 해당되는 Provider가 없을 경우 기본 값 ( 여기에서는 'light' )을 사용합니다.
...
## 14.3 컨텍스트를 사용하기 전에 고려할 점
    ...
    왜냐하면 컴포넌트와 컨텍스트가 연동되면 '재사용성'이 떨어지기 때문입니다.

    따라서 다른 레벨의 많은 컴포넌트가 에디터를 필요로 하는 경우가 아니면 props를 통해 데이터를 전달하는
    컴포넌트 합성 방법이 더 적합 합니다.

![image](https://github.com/leegeonho1/23-react1/assets/118963538/4e61819b-79d0-4872-b02c-b526c6706a14)
